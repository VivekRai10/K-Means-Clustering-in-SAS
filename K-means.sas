libname S 'D:\Google Drive\alabs\Analytics\BA\Clustering and factoring\K-means (SAS)';

proc contents data=s.telco_SAS;
run;

/*Calculating means and STD to identify outliers*/
ods html file='C:\Users\Sumeet Bansal\Google Drive\alabs\Analytics\BA\Clustering and factoring\K-means (SAS)\desc.xls';
...
ods html file='C:\Users\Sumeet Bansal\Google Drive\alabs\Analytics\BA\Clustering and factoring\K-means (SAS)\profiling.xls';
